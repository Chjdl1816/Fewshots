...
from gtad_lib.models2 import GTAD
...
if __name__ == '__main__':
    ...
    opt = opts.parse_opt()
    opt = vars(opt)
    opt['meta_learn'] = False
    opt['multi_instance'] = False
    ...
    if opt["meta_learn"]:
        valid_mode = "Episodic_train" ## "Standard" or "Episodic"      Episodic_train
    else:
    ...
    elif valid_mode == "Episodic_train" :            #这个
